...
namespace WebApiZatvorskaJedinica.Controllers
{
    ...
    public class ZatvorskaJedinicaController : ControllerBase
    {
        ...
        public IActionResult GetAllZJFULL()
        {
            try
            {
                return new JsonResult(DTOManager.ReadAllZatvorskaJedinicaFULL());
            }
            catch(Exception exc)
            {
        ...
        public IActionResult GetAllZJ()
        {
            try
            {
                return new JsonResult(DTOManager.ReadAllZatvorskaJedinica());
            }
            catch (Exception exc)
            {
                return BadRequest(exc.ToString());
        ...
        public IActionResult GetZJFULL(string Sifra)
        {
            try
            {
                return new JsonResult(DTOManager.ReadZatvorskaJedinicaFULL(Sifra));
            }
            catch (Exception exc)
            {
                return BadRequest(exc.ToString());
        ...
        public IActionResult GetZJ(string Sifra)
        {
            try
            {
                return new JsonResult(DTOManager.ReadZatvorskaJedinica(Sifra));
            }
            catch (Exception exc)
            {
                return BadRequest(exc.ToString());
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public IActionResult CreateZJ([FromBody] ZatvorskaJedinicaBasic zj)
        {
            try
            {
                DTOManager.CreateZatvorskaJedinica(zj);
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public IActionResult UpdateZJ([FromBody] ZatvorskaJedinicaBasic zj)
        {
            try
            {
                DTOManager.UpdateZatvorskaJedinica(zj);
                return new JsonResult(zj);
            }
            catch (Exception exc)
            {
        ...
        public IActionResult DeleteZJ(string Sifra)
        {
            try
            {
                DTOManager.DeleteZatvorskaJedinica(Sifra);
                return Ok();
            }
            catch (Exception exc)
            {
