...
{
    public partial class FormIzmeniZatvorenika : Form
    {
        ...
        public FormIzmeniZatvorenika(ref ZatvorenikBasic z)
        {
            Zatvorenik = z;
            InitializeComponent();
        }

        private void FormIzmeniZatvorenika_Load(object sender, EventArgs e)
        {
            ...
            buttonPregledPoseta.Enabled = false;
        ...
        private void buttonDodajPrestup_Click(object sender, EventArgs e)
        {
            ...
            DTOManager.CreatePrestup(this.Zatvorenik.Prestupi[i]);
        ...
        private void FormIzmeniZatvorenika_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = (DialogResult != DialogResult.OK &&
                MessageBox.Show(this,
                "Jeste li sigurni da želite otkazati izmenu zatvorenika?\nUneti podaci neće biti sačuvani!",
                "Pitanje",
        ...
        private void buttonSacuvajIzmenePrestup_Click(object sender, EventArgs e)
        {
            if (ValidacijaPrestupa())
            {
                ...
                DTOManager.UpdatePrestup(Zatvorenik.Prestupi[val]);
                OcistiPrestup();
        ...
        private void buttonUkloniAdvokata_Click(object sender, EventArgs e)
        {
            ...
            foreach (ZastupaBasic z in forDel)
            {
                ...
                DTOManager.DeleteZastupa(z);
            }

            listViewAdvokati.Focus();
        }
        private void FormIzmeniZatvorenika_Shown(object sender, EventArgs e)
        {
            MessageBox.Show(this,
                "Promene načinjene u okviru prestupa i zastupanja advokata su automatski sačuvana i moraju se ručno poništiti!",
                "Upozorenje",
                MessageBoxButtons.OK,
        ...
        {
            Form f = new FormPregledPoseta(Zatvorenik, Zatvorenik.Zastupa[listViewAdvokati.SelectedIndices[0]].Advokat, true);
            f.ShowDialog();
        }
        ...
        private void UcitajPolja()
        {
            ...
            textBoxAdresa.Text = String.IsNullOrEmpty(Zatvorenik.Adresa) ? "" : Zatvorenik.Adresa;

            textBoxBroj.Text = Zatvorenik.Broj;
            dateTimePickerInkarceracija.Value = Zatvorenik.DatumInkarceracije;
            dateTimePickerSledeceSaslusanje.Value = Zatvorenik.DatumSledecegSaslusanja == null ? DateTime.Now : (DateTime) Zatvorenik.DatumSledecegSaslusanja;
            comboBoxStatusUslovnogOtpusta.Text = Zatvorenik.StatusUslovnogOtpusta;

            comboBoxZatvorskaJedinica.SelectedIndex = ZatvorskeJedinice.IndexOf(Zatvorenik.ZatvorskaJedinica);
        ...
        private bool ValidacijaPrestupa()
        {
            ...
            if (numericUpDownMinKazna.Value < 0 || numericUpDownMaxKazna.Value < 0)
            {
                MessageBox.Show(this,
                    "Kazna mora biti veća ili jednaka 0!",
                    "Greška",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Error);
                return false;
