...
KAPACITET NUMBER NOT NULL CHECK (KAPACITET > 0),
O_REZIM NUMBER(1) NOT NULL CHECK (O_REZIM IN (0, 1)) ,
PO_REZIM NUMBER(1) NOT NULL CHECK (PO_REZIM IN (0, 1)),
S_REZIM NUMBER(1) NOT NULL CHECK (S_REZIM IN (0, 1))
);
...
-- ZAPOSLENI
RADNO_MESTO VARCHAR(100) CHECK(RADNO_MESTO IN('Administracija', 'Psiholog', 'Radnik obezbeđenja')) NOT NULL,
...
CONSTRAINT POSECUJE_UNIQUE UNIQUE (JMBG_ZAT, JMBG_ADV, DT_POCETKA),
